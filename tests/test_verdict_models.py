...
def test_unknown_queried_id_is_ignored() -> None:
    manifest = load_manifest(FIXTURE)
    assert _scan(manifest, {"model.other.thing"}) == {STG, FCT}
