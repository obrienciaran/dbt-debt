...
class RealRedshiftClient:
    ...
    def __init__(self, config: Config, database: str | None = None) -> None:
        ...
        except redshift_connector.Error as exc:  # type: ignore[attr-defined, unused-ignore]
            raise MissingCredentialsError(
    ...
    def _run(self, sql: str, stage: str) -> list[dict[str, Any]]:
        ...
        try:
            ...
            try:
                ...
                cursor.close()
        except redshift_connector.ProgrammingError:  # type: ignore[attr-defined, unused-ignore]
            raise
        except redshift_connector.Error as exc:  # type: ignore[attr-defined, unused-ignore]
            raise WarehouseError(f"Redshift query for {stage} failed: {exc}") from exc
        return [
...
def _programming_error() -> type[Exception]:
    ...
    return cast("type[Exception]", redshift_connector.ProgrammingError)  # type: ignore[attr-defined, unused-ignore]
